...
//    1. Call Viob_soc_sim::{export_function} instead,
//       and do not even bother to compile this file
// or 2. Compile all __Dpi.cpp files in the same compiler run,
//       and #ifdefs already inserted here will sort everything out.

#include "Viob_soc_sim__Dpi.h"
...
int simutil_get_scramble_key(svBitVecVal* val) {
    ...
    return Viob_soc_sim::simutil_get_scramble_key(val);
}
#endif
...
int simutil_get_scramble_nonce(svBitVecVal* nonce) {
    ...
    return Viob_soc_sim::simutil_get_scramble_nonce(nonce);
}
#endif
