...
VL_INLINE_OPT void Viob_soc_sim_iob_soc_axi_full_xbar_split__pi2___nba_sequent__TOP__iob_soc_sim__DOT__iob_soc_memwrapper__DOT__iob_core_inst__DOT__iob_axi_full_xbar__DOT__iob_axi_split_0__0(Viob_soc_sim_iob_soc_axi_full_xbar_split__pi2* vlSelf) {
    ...
    vlSelf->__PVT__data_burst_complete_write_reg_re__DOT__reg0__DOT__data_next 
        = ((~ (IData)(vlSymsp->TOP.arst_i)) & (IData)(vlSelf->__PVT__data_burst_complete_write_reg_o));
    if (vlSelf->__PVT__active_transaction_write_reg_o) {
        vlSelf->__PVT__active_transaction_write_reg_re__DOT__reg0__DOT__data_next 
            = (1U & (~ (IData)(vlSymsp->TOP.arst_i)));
        vlSelf->__PVT__write_sel = vlSelf->__PVT__write_sel_reg;
    } else {
        vlSelf->__PVT__active_transaction_write_reg_re__DOT__reg0__DOT__data_next = 0U;
        vlSelf->__PVT__write_sel = 0U;
    }
...
VL_INLINE_OPT void Viob_soc_sim_iob_soc_axi_full_xbar_split__pi2___nba_comb__TOP__iob_soc_sim__DOT__iob_soc_memwrapper__DOT__iob_core_inst__DOT__iob_axi_full_xbar__DOT__iob_axi_split_0__1(Viob_soc_sim_iob_soc_axi_full_xbar_split__pi2* vlSelf) {
    ...
    vlSelf->m0_axi_arid_o = ((0U == (IData)(vlSelf->__PVT__read_sel))
                              ? (IData)(vlSymsp->TOP.iob_soc_sim__DOT__iob_soc_memwrapper__DOT__iob_core_inst__DOT__cpu_i_axi_arid)
                              : 0U);
...
VL_INLINE_OPT void Viob_soc_sim_iob_soc_axi_full_xbar_split__pi2___nba_comb__TOP__iob_soc_sim__DOT__iob_soc_memwrapper__DOT__iob_core_inst__DOT__iob_axi_full_xbar__DOT__iob_axi_split_0__2(Viob_soc_sim_iob_soc_axi_full_xbar_split__pi2* vlSelf) {
    ...
    __Vtableidx5 = 0;
    // Body
    __Vtableidx1 = (((IData)(vlSymsp->TOP__iob_soc_sim__DOT__iob_soc_memwrapper__DOT__iob_core_inst__DOT__iob_axi_full_xbar__DOT__iob_axi_merge_2.s0_axi_awready_o) 
                     << 4U) | (((IData)(vlSymsp->TOP__iob_soc_sim__DOT__iob_soc_memwrapper__DOT__iob_core_inst__DOT__iob_axi_full_xbar__DOT__iob_axi_merge_1.s0_axi_awready_o) 
                                << 3U) | (((IData)(vlSymsp->TOP__iob_soc_sim__DOT__iob_soc_memwrapper__DOT__iob_core_inst__DOT__iob_axi_full_xbar__DOT__iob_axi_merge_0.s0_axi_awready_o) 
                                           << 2U) | (IData)(vlSelf->__PVT__write_sel))));
    vlSelf->__PVT__mux_axi_awready_o = Viob_soc_sim__ConstPool__TABLE_h9751e8f9_0
        [__Vtableidx1];
    vlSelf->__PVT__iob_mux_axi_awready__DOT__input_sel 
        = Viob_soc_sim__ConstPool__TABLE_h2988ed14_0
        [__Vtableidx1];
    __Vtableidx2 = (((IData)(vlSymsp->TOP__iob_soc_sim__DOT__iob_soc_memwrapper__DOT__iob_core_inst__DOT__iob_axi_full_xbar__DOT__iob_axi_merge_2.s0_axi_wready_o) 
                     << 4U) | (((IData)(vlSymsp->TOP__iob_soc_sim__DOT__iob_soc_memwrapper__DOT__iob_core_inst__DOT__iob_axi_full_xbar__DOT__iob_axi_merge_1.s0_axi_wready_o) 
                                << 3U) | (((IData)(vlSymsp->TOP__iob_soc_sim__DOT__iob_soc_memwrapper__DOT__iob_core_inst__DOT__iob_axi_full_xbar__DOT__iob_axi_merge_0.s0_axi_wready_o) 
                                           << 2U) | (IData)(vlSelf->__PVT__write_sel))));
    vlSelf->__PVT__mux_axi_wready_o = Viob_soc_sim__ConstPool__TABLE_h9751e8f9_0
        [__Vtableidx2];
    vlSelf->__PVT__iob_mux_axi_wready__DOT__input_sel 
        = Viob_soc_sim__ConstPool__TABLE_h2988ed14_0
        [__Vtableidx2];
    ...
    vlSelf->__PVT__mux_axi_arready_o = Viob_soc_sim__ConstPool__TABLE_h9751e8f9_0
        [__Vtableidx5];
    vlSelf->__PVT__iob_mux_axi_arready__DOT__input_sel 
        = Viob_soc_sim__ConstPool__TABLE_h2988ed14_0
        [__Vtableidx5];
    vlSelf->s_axi_arready_o = ((~ (IData)(vlSelf->__PVT__active_transaction_read_reg_o)) 
                               & (IData)(vlSelf->__PVT__mux_axi_arready_o));
    vlSelf->__PVT__active_transaction_read_reg_re__DOT__reg0__DOT__data_next 
        = ((~ (IData)(vlSelf->__PVT__active_transaction_read_reg_rst)) 
           & (((IData)(vlSymsp->TOP__iob_soc_sim__DOT__iob_soc_memwrapper__DOT__iob_core_inst__DOT__cpu__DOT__u_top__DOT__u_ibex_core.instr_req_o) 
               & (IData)(vlSelf->s_axi_arready_o)) 
...
VL_INLINE_OPT void Viob_soc_sim_iob_soc_axi_full_xbar_split__pi2___nba_comb__TOP__iob_soc_sim__DOT__iob_soc_memwrapper__DOT__iob_core_inst__DOT__iob_axi_full_xbar__DOT__iob_axi_split_1__2(Viob_soc_sim_iob_soc_axi_full_xbar_split__pi2* vlSelf) {
    ...
    vlSelf->s_axi_wready_o = ((~ (IData)(vlSelf->__PVT__data_burst_complete_write_reg_o)) 
                              & (IData)(vlSelf->__PVT__mux_axi_wready_o));
    vlSelf->s_axi_arready_o = ((~ (IData)(vlSelf->__PVT__active_transaction_read_reg_o)) 
                               & (IData)(vlSelf->__PVT__mux_axi_arready_o));
    vlSelf->__PVT__data_burst_complete_write_reg_re__DOT__reg0__DOT__data_next 
        = ((~ (IData)(vlSelf->__PVT__active_transaction_write_reg_rst)) 
