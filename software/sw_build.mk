...
IOB_SOC_FW_SRC+=src/$(APP).c  # Application choose source file
...
iob_soc_firmware: iob_bsp
	$(MAKE) $@.elf INCLUDES="$(IOB_SOC_INCLUDES)" \
	    LFLAGS="$(IOB_SOC_LFLAGS) -Wl,-Map,$@.map" \
	    SRC="$(IOB_SOC_FW_SRC)" TEMPLATE_LDS="$(TEMPLATE_LDS)" APP="$(APP)"
